...
const Certificate = ({ className }: IconProps) => {
  return (
    <svg
      ...
      viewBox="0 0 329.6 409.6"
      className={`svg-inject icon-svg ${className || 'icon-svg-md text-primary me-5'}`}
    >
      <path
        className="lineal-fill"
        d="M98.7 13.5v66.1c0 9.6-7.8 17.3-17.3 17.3H13.7c-1 0-1.8-.8-1.8-1.8v-.2C13 85.8 17.2 77.4 23.6 71l47.3-47.3c6.9-6.9 16-11.1 25.8-11.9 1-.1 1.9.6 2 1.6v.1z"
      />
      <path
